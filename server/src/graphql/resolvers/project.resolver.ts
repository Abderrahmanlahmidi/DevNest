...
export const projectResolvers = {
    ...
    Mutation: {
        createProject: async (_: any, args: any) => {
            const { title, description, technologies, startDate, status, githubUrl, liveUrl, image, userId } = args;
        ...
        updateProject: async (_: any, args: any) => {
            const { id, title, description, technologies, startDate, status, githubUrl, liveUrl, image } = args;
