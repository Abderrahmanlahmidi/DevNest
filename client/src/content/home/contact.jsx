                        ...
                        <div className="space-y-8">
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-500 text-sm mb-1">hello@devnest.com</p>
                                    <p className="text-gray-400 text-xs">Typically replies within 24 hours</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-400 text-xs">Mon-Fri from 9am to 6pm</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-500 text-sm mb-1">San Francisco, CA</p>
                            ...
                            <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                                <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <span className="text-green-800 text-sm font-medium">Available for new projects</span>
                                </div>
