...
const Hero = () => {
    ...
    const downloadResume = () => {
        const pdfUrl = "../../../src/assets/documents/Abderrahmane-Lahmidi.pdf";
    ...
    return (
        <section id='home' className="min-h-screen bg-white flex items-center justify-center px-4 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto text-center">
                ...
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-light text-gray-800 mb-4 tracking-tight">
                    Hello, I'm{' '}
                    <span className="text-gray-600 font-normal">Lahmidi Abderrahmane</span>
                </h1>
                ...
                <p className="text-gray-400 max-w-2xl mx-auto mb-12 leading-relaxed text-lg">
                    ...
                    using React, Node.js, and modern development practices. 
                    Currently focused on building scalable solutions at DevNest.
                </p>

                {/* CTA Buttons */}
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
                    <button className="bg-gray-800 text-white px-8 py-3 rounded-full text-sm font-normal hover:bg-gray-700 transition-all duration-300 flex items-center gap-2 group">
                        View My Work
                        <FiArrowRight className="group-hover:translate-x-1 transition-transform" />
                    </button>
                    <button onClick={downloadResume} className="border border-gray-300 text-gray-600 px-8 py-3 rounded-full text-sm font-normal hover:border-gray-400 hover:text-gray-700 transition-all duration-300">
                        Download CV
                    </button>
                </div>
